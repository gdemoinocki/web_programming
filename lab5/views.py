...
def anketa(request):
    ...
    interests = {'1': 'Игры', '2': 'Сериалы', '3': 'Мультсериалы','4': 'Аниме', '5': 'Комиксы', '6': 'Книги', '7': 'Другое'} 
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            data['interests'] = interests[form.cleaned_data['interests']]
            data['evaluation'] = evaluation[form.cleaned_data['evaluation']]
